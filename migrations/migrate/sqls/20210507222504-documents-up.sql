CREATE TABLE `documents` (
  ...
  CONSTRAINT documents_products_stakeholder_id_fk FOREIGN KEY (stakeholder_id) REFERENCES stakeholders(id),
  CONSTRAINT documents_products_operation_id_fk FOREIGN KEY (operation_id) REFERENCES operations(id),
